...
overwrite_to_file()
{
  ...
  base16-builder --scheme "db/schemes/base2tone-mall.yml" --template "db/templates/alacritty/dark.ejs" > "config/alacritty-base2tone-mall-dark.yml"
  base16-builder --scheme "db/schemes/base2tone-mall.yml" --template "db/templates/alacritty/light.ejs" > "config/alacritty-base2tone-mall-light.yml"
  base16-builder --scheme "db/schemes/base2tone-porch.yml" --template "db/templates/alacritty/dark.ejs" > "config/alacritty-base2tone-porch-dark.yml"
  base16-builder --scheme "db/schemes/base2tone-porch.yml" --template "db/templates/alacritty/light.ejs" > "config/alacritty-base2tone-porch-light.yml"
  base16-builder --scheme "db/schemes/base2tone-field.yml" --template "db/templates/alacritty/dark.ejs" > "config/alacritty-base2tone-field-dark.yml"
  base16-builder --scheme "db/schemes/base2tone-field.yml" --template "db/templates/alacritty/light.ejs" > "config/alacritty-base2tone-field-light.yml"
  base16-builder --scheme "db/schemes/base2tone-motel.yml" --template "db/templates/alacritty/dark.ejs" > "config/alacritty-base2tone-motel-dark.yml"
  base16-builder --scheme "db/schemes/base2tone-motel.yml" --template "db/templates/alacritty/light.ejs" > "config/alacritty-base2tone-motel-light.yml"
  ...
  cp "config/alacritty-base2tone-mall-dark.yml" "/Users/bram/.config/alacritty/alacritty.yml"
